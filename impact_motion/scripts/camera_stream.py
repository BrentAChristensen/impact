...
class ObjectDetection(object):
    def __init__(self):
        self.image_sub = rospy.Subscriber("/simple_camera/image_raw", Image, self.camera_callback)
    ...
    def camera_callback(self, data):
        ...
        mask_b = cv.inRange(hsv, min_blue, max_blue)
        ...
        for cnt in contours:
            cv.polylines(cv_image, [cnt], True, [0, 0, 255], 1)
